...
class GroupCollection {
  ...
  static GroupCollection fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<GroupCollection> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(GroupCollection.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <GroupCollection>[];

  static Map<String, GroupCollection> mapFromJson(dynamic json) {
    final map = <String, GroupCollection>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = GroupCollection.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of GroupCollection-objects as value to a dart map
  static Map<String, List<GroupCollection>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<GroupCollection>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = GroupCollection.listFromJson(
            value,
