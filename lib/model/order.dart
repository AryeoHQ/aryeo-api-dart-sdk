...
class Order {
  ...
  @override
  String toString() => 'Order[id=$id, number=$number, title=$title, fulfillmentStatus=$fulfillmentStatus, paymentStatus=$paymentStatus, currency=$currency, totalAmount=$totalAmount, paymentUrl=$paymentUrl, statusUrl=$statusUrl]';
