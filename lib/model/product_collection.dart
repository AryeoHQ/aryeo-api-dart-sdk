...
class ProductCollection {
  ...
  static ProductCollection fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ProductCollection> listFromJson(dynamic json, {bool emptyIsNull, bool growable,}) =>
    json is List && json.isNotEmpty
      ? json.map(ProductCollection.fromJson).toList(growable: true == growable)
      : true == emptyIsNull ? null : <ProductCollection>[];

  static Map<String, ProductCollection> mapFromJson(dynamic json) {
    final map = <String, ProductCollection>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) => map[key] = ProductCollection.fromJson(value));
    }
    return map;
  }

  // maps a json object with a list of ProductCollection-objects as value to a dart map
  static Map<String, List<ProductCollection>> mapListFromJson(dynamic json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ProductCollection>>{};
    if (json is Map && json.isNotEmpty) {
      json
        .cast<String, dynamic>()
        .forEach((key, dynamic value) {
          map[key] = ProductCollection.listFromJson(
            value,
