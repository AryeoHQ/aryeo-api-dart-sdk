...
// tests for UnconfirmedAppointment
void main() {
  final instance = UnconfirmedAppointment();

  group('test UnconfirmedAppointment', () {
    ...
    test('to test the property `preferenceType`', () async {
      // TODO
    });
    ...
    test('to test the property `preferredStartAt`', () async {
      // TODO
    });
    ...
    test('to test the property `preferredStartAtDay`', () async {
      // TODO
    });
    ...
    // String preferredStartAtTimeOfDay
    test('to test the property `preferredStartAtTimeOfDay`', () async {
      // TODO
    });
