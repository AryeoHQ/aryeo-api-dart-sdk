...
void main() {
  ...
  group('test Listing', () {
    ...
    // String mlsNumber
    test('to test the property `mlsNumber`', () async {
      // TODO
    });
    ...
    test('to test the property `standardStatus`', () async {
      // TODO
    });
    ...
    // Group listAgent
    test('to test the property `listAgent`', () async {
      // TODO
    });

    // Group coListAgent
    test('to test the property `coListAgent`', () async {
      // TODO
    });

    // images
    // List<Image> images (default value: const [])
    test('to test the property `images`', () async {
      // TODO
    });

    // videos
    // List<Video> videos (default value: const [])
    test('to test the property `videos`', () async {
      // TODO
    });

    // floor_plans
    // List<FloorPlan> floorPlans (default value: const [])
    test('to test the property `floorPlans`', () async {
      // TODO
    });

    // interactive_content
    // List<InteractiveContent> interactiveContent (default value: const [])
    test('to test the property `interactiveContent`', () async {
      // TODO
    });

    // PropertyWebsite propertyWebsite
    test('to test the property `propertyWebsite`', () async {
      // TODO
    });
    ...
    test('to test the property `downloadsEnabled`', () async {
      // TODO
    });
