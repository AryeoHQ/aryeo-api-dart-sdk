...
void main() {
  ...
  group('test Address', () {
    ...
    // String unitNumber
    test('to test the property `unitNumber`', () async {
      // TODO
    });
    ...
    // String cityRegion
    test('to test the property `cityRegion`', () async {
      // TODO
    });

    // The County, Parish or other regional authority of the location.
    // String countyOrParish
    test('to test the property `countyOrParish`', () async {
      // TODO
    });
    ...
    test('to test the property `stateOrProvinceRegion`', () async {
      // TODO
    });
    ...
    test('to test the property `countryRegion`', () async {
      // TODO
    });

    // Unparsed text representation of the address. 
    // String unparsedAddress
    test('to test the property `unparsedAddress`', () async {
      // TODO
    });
    ...
    test('to test the property `unparsedAddressPartOne`', () async {
      // TODO
    });
    ...
    test('to test the property `unparsedAddressPartTwo`', () async {
      // TODO
    });
